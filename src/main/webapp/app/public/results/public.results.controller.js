(function() {
    ...
    PublicResultsController.$inject = ['$scope','$state','ParseLinks','pagingParams', 'paginationConstants','Association','Division','Club','AssociationExt'];

    function PublicResultsController ($scope, $state,ParseLinks,pagingParams, paginationConstants,Association,Division,Club,AssociationExt) {
        var vm = this;
        vm.associations = [];
        vm.divisions = [];
        vm.clubs = [];
        ...
        function loadResults(){
            ...
            AssociationExt.queryAssociationResults({
