...
public class SquadResource {
    ...
    @RequestMapping(value = "/squads",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<Squad>> getAllSquads(Pageable pageable)
        throws URISyntaxException {
        log.debug("REST request to get a page of Squads");
        Page<Squad> page = squadRepository.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/squads");
