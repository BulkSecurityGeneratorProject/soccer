...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'src/main/webapp/bower_components/isteven-angular-multiselect/isteven-multi-select.js',
            'src/main/webapp/bower_components/angular-simple-grid/src/simple-grid.js',
